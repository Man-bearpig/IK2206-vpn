...
public class ForwardClient
{
    ...
    static public void startForwardClient() throws Exception {
        ...
        ForwardServerClientThread forwardThread =
                new ForwardServerClientThread(proxySocket, clientHandshake.sessionHost, clientHandshake.sessionPort,clientHandshake.sessionKey,clientHandshake.sessionIV,true);
        /*
         * Launch the fowarder
         */
        forwardThread.start();
