...
public class ForwardServer
{
            ...
            throws Exception
    {
        ...
        while(true) {
            ...
            String serverPrivateKeyFile=arguments.get("key");
            Logger.log("Incoming handshake connection from " + clientHostPort);

            doHandshake(handshakeSocket,cacert,usercert,serverPrivateKeyFile);
            ...
            forwardThread = new ForwardServerClientThread(serverHandshake.sessionSocket,
                    serverHandshake.targetHost, serverHandshake.targetPort, serverHandshake.sessionKey, serverHandshake.sessionIV,false);
            forwardThread.start();
        }
    }
