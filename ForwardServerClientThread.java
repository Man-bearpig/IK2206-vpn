...
public class ForwardServerClientThread extends Thread
{
     ...
     */
    public ForwardServerClientThread(ServerSocket listensocket, String serverhost, int serverport, byte[]sessionKey, byte[] sessionIV,boolean cl) throws IOException, InvalidAlgorithmParameterException, NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException {
        fl = cl;
    ...
    public void run()
    {
        try {
            ...
            for(int timer = 0;mServerSocket==null && timer<=100;timer++) {   //Wait for 20 seconds for target response.
                try {
